      ...
      "IndividualModel": {
        "mappings": {
          ...
          "name": {
            ...
            "familyName": "beneficiaryDetails.familyNameOfIndividual",
    ...
    "models": {
      ...
      "ProjectBeneficiaryModel": {
        "mappings": {
          ...
          "tag": "beneficiaryDetails.tag",
          "beneficiaryClientReferenceId":
              "__switch:__context:beneficiaryType:{INDIVIDUAL:__ref:IndividualModel.clientReferenceId,HOUSEHOLD:__ref:__context:householdModel.clientReferenceId}",
          "nonRecoverableError": "errors.nonRecoverable",
          "clientReferenceId": "__generate:uuid",
